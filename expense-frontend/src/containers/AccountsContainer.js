...
import {Route, Switch} from 'react-router-dom' //allows access to Route tag, bc all of this is wrapped in Router from index
      ...
      return (
          <div>
            ...
            <Switch>
              ...
              {/* this.props.accounts allows listing of all accounts, below also originally used Route exact path */}
